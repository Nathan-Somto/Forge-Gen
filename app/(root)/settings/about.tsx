...
export default function About() {
  ...
  return (
    <PrimaryBackground>
      ...
      <View>
        <Text className="text-[20px] my-4 text-center">Version {version}</Text>
      </View>
      <View
      ...
      <View className="w-[90%] mx-auto mt-8">
        <Text style={{ color: Colors.neutral }} className="text-center">
          Forge Gen is a next Gen Ai-Powered Image Editor that enables seamless
          transformations with the click of a button.
        </Text>
      </View>
      <GradientButton containerClassName="w-[70%] mx-auto mt-6">Rate Us</GradientButton>
      </View>
    </PrimaryBackground>
  );
}
