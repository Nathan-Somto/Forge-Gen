import { Account, Avatars, Client, Databases, Functions, Storage } from "react-native-appwrite";
...
const appwriteConfig = {
  ...
  cldfunctionId: process.env.EXPO_PUBLIC_APPWRITE_CLOUDINARY_FUNCTION_ID ?? '',
}
...
export {account,database, avatar, appwriteConfig, storage, functions};